...
public class BulkUpdateOfficialsProofSimulation extends Simulation {
  private static final String SEEDED_LIST_ID = requiredEnvironmentVariable("APPREG_SEED_BULK_OFFICIALS_LIST_ID");
  private static final String SEEDED_ENTRY_ID_ONE = requiredEnvironmentVariable("APPREG_SEED_BULK_OFFICIALS_ENTRY_ID_1");
  private static final String SEEDED_ENTRY_ID_TWO = requiredEnvironmentVariable("APPREG_SEED_BULK_OFFICIALS_ENTRY_ID_2");
  private static final String SEEDED_ENTRY_ID_THREE = requiredEnvironmentVariable("APPREG_SEED_BULK_OFFICIALS_ENTRY_ID_3");
