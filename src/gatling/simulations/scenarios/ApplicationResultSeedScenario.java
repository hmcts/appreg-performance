...
public final class ApplicationResultSeedScenario {
  private static final String INITIAL_RESULT_CODE = "COST";
  private static final String INITIAL_WORDING_VALUE = "500 Pounds";
  ...
  public static ChainBuilder createExistingResult() {
    return group("AppReg_055_Application_Result_Seed").on(
      exec(http("Create proof setup result")
        ...
        .body(StringBody("""
          {"resultCode":"%s","wordingFields":[{"key":"Amount of costs","value":"%s"}]}
          """.formatted(INITIAL_RESULT_CODE, INITIAL_WORDING_VALUE)))
